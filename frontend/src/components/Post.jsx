...
const Post = ({ post }) => {
  ...
  const isOwner = authUser.content._id === post.author._id;
  const isLiked = post.likes.includes(authUser.content._id);
    ...
    if (newComment.trim()) {
      ...
      setComments([
        ...comments,
        {
          content: newComment,
          user: {
            _id: authUser.content._id,
            name: authUser.content.name,
            profilePicture: authUser.content.profilePicture,
          },
          createdAt: new Date(),
        },
      ]);
